...
function samples = generate_samples_rbm(pattern_posteriors, feature_counts, num_samples, ...
...
while (s <= num_samples)
    ...
    for i=1:num_features
        feature_dist = pattern_counts{i};
        feature_dist(feature_dist > 0) = 1;
        feature_dist = feature_dist ./ sum(feature_dist);
