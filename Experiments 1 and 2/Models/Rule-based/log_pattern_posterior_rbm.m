...
%     - nexamples: number of training examples
%
...
function p = log_pattern_posterior_rbm(pattern_index, feature_frequencies, nexamples)
...
if (pattern_index == 1)
    ...
    for i=1:1
        ...
        p = p + log(1 / length(feature_i(feature_i ~= 0))) * nexamples;
    end
